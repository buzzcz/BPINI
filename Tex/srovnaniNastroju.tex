...
\vspace{-\topsep}
\begin{itemize}
	\item \textbf{Natural-like} -- víceméně okleštěný přirozený jazyk založený na angličtině,
	\item \textbf{Složitost tvorby} -- míní se tím složitost přípravy reportu a~v~tabulce vyšší počet bodů znamená jednodušší tvorbu pro tvůrce skriptů
\end{itemize}
\begin{figure}[ht!]
