		...
		if (run) {
			try {
				...
				assertTrue("Očekáváno: -5, zjištěno něco jiného", s.find(pngs + "labely/vystupLabel.png").right(200)
						.grow(0, 10).exists(pngs + "vystupy/vystupMinus5.png") != null);
				assertTrue("Nenalezeno upozornění o chybě", s.exists(pngs + "chyby/chybaZaporneCislo.png") != null);
		...
		if (run) {
			try {
				...
				assertTrue("Očekáváno: -5.1, zjištěno něco jiného", s.find(pngs + "labely/vystupLabel.png").right(200)
						.grow(0, 10).exists(pngs + "vystupy/vystupMinus5_1.png") != null);
				assertTrue("Nenalezeno upozornění o chybě", s.exists(pngs + "chyby/chybaZaporneCislo.png") != null);
			} catch (FindFailed | AssertionError e) {
				s.capture().save("errors", screenshotName());
				logger.error(e.getMessage());
	...
	public void TC02_06_03ZaporneCisloVedeckyFormatKladnyVelkeE() {
		if (run) {
			try {
				...
				s.click(pngs + "tlacitka/tlacitkoPreved.png");
				s.wait(pngs + "tlacitka/tlacitkoPreved.png", 5);
				assertTrue("Očekáváno: -51, zjištěno něco jiného", s.find(pngs + "labely/vystupLabel.png").right(200)
						.grow(0, 10).exists(pngs + "vystupy/vystupMinus51.png") != null);
				assertTrue("Nenalezeno upozornění o chybě", s.exists(pngs + "chyby/chybaZaporneCislo.png") != null);
			} catch (FindFailed | AssertionError e) {
				s.capture().save("errors", screenshotName());
				logger.error(e.getMessage());
	...
	public void TC02_06_04ZaporneCisloVedeckyFormatZapornyMaleE() {
		if (run) {
			try {
				...
				s.click(pngs + "tlacitka/tlacitkoPreved.png");
				s.wait(pngs + "tlacitka/tlacitkoPreved.png", 5);
				assertTrue("Očekáváno: -0.51, zjištěno něco jiného", s.find(pngs + "labely/vystupLabel.png").right
						(200).grow(0, 10).exists(pngs + "vystupy/vystupMinus0_51.png") != null);
				assertTrue("Nenalezeno upozornění o chybě", s.exists(pngs + "chyby/chybaZaporneCislo.png") != null);
			} catch (FindFailed | AssertionError e) {
				s.capture().save("errors", screenshotName());
				logger.error(e.getMessage());
	...
	public void TC02_06_05NevyplnenePole() {
		if (run) {
			try {
				...
				s.click(pngs + "tlacitka/tlacitkoPreved.png");
				s.wait(pngs + "tlacitka/tlacitkoPreved.png", 5);
				assertTrue("Očekáváno: \"\", zjištěno něco jiného", s.find(pngs + "labely/vystupLabel.png").right()
						.grow(0, 10).exists(pngs + "textovaPole/vystupniTextovePole.png") != null);
				assertTrue("Nenalezeno upozornění o chybě", s.exists(pngs + "chyby/chybaPrazdnePole.png") != null);
			} catch (FindFailed | AssertionError e) {
				s.capture().save("errors", screenshotName());
				logger.error(e.getMessage());
				fail(e.getMessage());
	...
	public void TC02_06_06NepovolenyZnakNeboZapis() {
		if (run) {
			try {
				...
				assertTrue("Očekáváno: \"\", zjištěno něco jiného", s.find(pngs + "labely/vystupLabel.png").right()
						.grow(0, 10).exists(pngs + "textovaPole/vystupniTextovePole.png") != null);
				assertTrue("Nenalezeno upozornění o chybě", s.exists(pngs + "chyby/chybaNeplatneCislo.png") != null);
			} catch (FindFailed | AssertionError e) {
				s.capture().save("errors", screenshotName());
				logger.error(e.getMessage());
				fail(e.getMessage());
